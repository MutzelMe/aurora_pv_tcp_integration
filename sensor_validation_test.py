#!/usr/bin/env python3
"""
Aurora Solar Sensor Validation Test
=====================================

PURPOSE:
--------
This script validates the sensor.py implementation BEFORE deploying to Home Assistant.
It tests the AuroraTCPClient directly to ensure:

1. SYNTAX VALIDITY: All sensor definitions are syntactically correct
2. LOGIC VALIDITY: Sensor mappings and calculations work as expected
3. CONNECTION HANDLING: Connection pooling and error handling work correctly
4. PERFORMANCE: No blocking calls or Event Loop issues

USAGE:
------
Run this script BEFORE implementing changes in Home Assistant:
    python3 sensor_validation_test.py

This helps catch errors early without affecting the production system.

IMPORTANT:
----------
This is NOT for testing actual inverter hardware or getting real values.
It's for validating the sensor.py code logic and structure.
"""
